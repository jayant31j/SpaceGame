...
player_data new_player()
{
    ...
    int x = (screen_width() - sprite_width(result.player_sprite)) / 2;
    int y = (screen_height() - sprite_height(result.player_sprite)) / 2;
...
void update_player(player_data &player_to_update)
{
    ...
    if (player_to_update.nos > 0)
    {
        player_to_update.nos -= 0.0002;
    }
    if (player_to_update.heart > 0)
    {
        player_to_update.heart -= 0.0002;
    }
}
